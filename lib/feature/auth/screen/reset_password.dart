...
import 'package:guven_a/feature/auth/controller/forgot_pass_otp_controller.dart';
import 'package:guven_a/feature/auth/controller/reset_password_controller.dart';
...
class ResetPassword extends StatelessWidget {
  ...
  final ResetPasswordController controllerEmail = Get.put(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Obx(
                    () => Text(
                      "${"sent_otp_to".tr} ${controllerEmail.getObscuredEmail()}",
                      style: globalTextStyle(
